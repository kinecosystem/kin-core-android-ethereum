...
For the SDK tests target, pre-actions and post-actions tasks in build.gradle(Module: kin-sdk-core) that will setup truffle and testrpc running for the duration of the test.
